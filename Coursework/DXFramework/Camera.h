...
public:
	...
	void moveForward(bool shouldSprint);			///< default function for moving forward
	void moveBackward(bool shouldSprint);		///< default function for moving backward
	void moveUpward(bool shouldSprint);			///< default function for moving upward
	void moveDownward(bool shouldSprint);		///< default function for moving downward
	...
	void strafeRight(bool shouldSprint);			///< default function for moving right
	void strafeLeft(bool shouldSprint);			///< default function for moving left
