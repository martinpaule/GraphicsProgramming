...
void Camera::moveForward(bool shouldSprint)
{
	float radians;

	// Update the forward movement based on the frame time
	speed = frameTime * (5.f + shouldSprint * 10.0f);
...
void Camera::moveBackward(bool shouldSprint)
{
	float radians;
...
void Camera::moveUpward(bool shouldSprint)
{
...
void Camera::moveDownward(bool shouldSprint)
{
...
void Camera::strafeRight(bool shouldSprint)
{
	float radians;
...
void Camera::strafeLeft(bool shouldSprint)
{
	float radians;
