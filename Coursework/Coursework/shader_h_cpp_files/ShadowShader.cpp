...
void ShadowShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX& world, const XMMATRIX& view, const XMMATRIX& projection, ID3D11ShaderResourceView* texture, ID3D11ShaderResourceView* depthMap, Light* light, ID3D11ShaderResourceView* depthMap2, Light* light2)
{
	...
	dataPtr->light2View = tLightViewMatrix2;
	dataPtr->light2Projection = tLightProjectionMatrix2;
